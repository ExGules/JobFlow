    ...
    <PageLayout>
      <section className="flex flex-col items-center py-16 text-center">
        ...
        <p className="mt-6 max-w-2xl text-lg text-[var(--color-text-secondary)]">
          Организуйте поиск работы в одном месте. Отслеживайте вакансии,
          собеседования и офферы без таблиц и блокнотов.
        </p>
      </section>

      <section className="mt-12 grid gap-6 md:grid-cols-3">
        <Card>
          <h3 className="font-semibold">Управление вакансиями</h3>
        ...
        <Card>
          <h3 className="font-semibold">Контроль собеседований</h3>
        ...
        <Card>
          <h3 className="font-semibold">Аналитика откликов</h3>
